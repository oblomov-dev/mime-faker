CLASS z2ui5_file_cl_db_api DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES ty_s_file TYPE z2ui5_file_t_001.
    TYPES ty_t_file TYPE STANDARD TABLE OF ty_s_file WITH EMPTY KEY.
...
CLASS Z2UI5_FILE_CL_DB_API IMPLEMENTATION.
  ...
  METHOD delete.
    ...
    DELETE FROM z2ui5_file_t_001 WHERE id = @id.
...
` csp, cssound_score, cssound_orchestra, cssound_document`.
  ...
  METHOD read.
    ...
    SELECT SINGLE FROM z2ui5_file_t_001
        FIELDS *
       WHERE id = @id
